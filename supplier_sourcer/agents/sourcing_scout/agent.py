"""sourcing-scout: finds and quality-ranks EU-certified suppliers per product."""
...
# This agent may fetch a supplier's page for contact details, so it gets WebFetch
# in addition to WebSearch.
